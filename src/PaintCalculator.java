...
public class PaintCalculator {
    ...
    public PaintCalculator() throws FileNotFoundException,
            ...
            try {
                ...
                switch (choice) {
                    case 1:
                        ...
                        break;
                    case 2:
                        System.out.println("Name of file to Write? ");
                        fileOutName = keyboard.nextLine();
                        RoomWriter.writeRooms(fileOutName, roomList);
                        break;
                    case 3:
                        System.out.println("Name of file to Read? ");
                        fileInName = keyboard.nextLine();
                        roomList = RoomReader.readRooms(fileInName);
                        break;
                    case 4:
                        printRooms();
                        break;
